...
public class WittyFeedSDKMain {
    ...
    public init(vc: UIViewController, wittyFeedSDKApiClient: WittyFeedSDKApiClient){
        ...
        self.wittyFeedSdkNetworking = WittyFeedSDKNetworking(vc: mainControllerContext!, api_client: wittyFeedSDKApiClient)
